...
Crawler.prototype._buildHttpRequest = function _buildHTTPRequest (options) {
	...
	var doRequest = function(err) {
		...
		var requestArgs = ['rejectUnauthorized', 'uri','url','qs','method','headers','body','form','formData','json','multipart','followRedirect','followAllRedirects', 'maxRedirects','encoding','pool','timeout','proxy','auth','oauth','strictSSL','jar','aws','gzip','time','tunnel','proxyHeaderWhiteList','proxyHeaderExclusiveList','localAddress','forever', 'agent'];
